...
use App\Models\UserExpiringCheque;
use Carbon\Carbon;
...
class UserExpiringChequeDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'userexpiringcheque.action')
            ->setRowId('id');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('userexpiringcheque-table')
    ...
    {
        return 'UserExpiringCheque_' . date('YmdHis');
    }
}
