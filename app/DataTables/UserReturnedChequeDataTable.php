...
use App\Models\UserReturnedCheque;
...
class UserReturnedChequeDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'userreturnedcheque.action')
            ->setRowId('id');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('userreturnedcheque-table')
    ...
    {
        return 'UserReturnedCheque_' . date('YmdHis');
    }
}
