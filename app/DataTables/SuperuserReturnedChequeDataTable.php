...
use App\Models\SuperuserReturnedCheque;
...
class SuperuserReturnedChequeDataTable extends DataTable
{
    /**
    ...
    {
        return $this->builder()
                    ->setTableId('superuserreturnedcheque-table')
    ...
    {
        return 'SuperuserReturnedCheque_' . date('YmdHis');
    }
}
